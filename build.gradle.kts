        ...
        if (!skipAutostyle) {
            autostyle {
                java {
                    ...
                    replace("hamcrest: allOf", "org.hamcrest.CoreMatchers.allOf", "org.hamcrest.core.AllOf.allOf")
                    replace("hamcrest: aMapWithSize", "org.hamcrest.Matchers.aMapWithSize", "org.hamcrest.collection.IsMapWithSize.aMapWithSize")
                    replace("hamcrest: anyOf", "org.hamcrest.CoreMatchers.anyOf", "org.hamcrest.core.AnyOf.anyOf")
                    replace("hamcrest: containsString", "org.hamcrest.CoreMatchers.containsString", "org.hamcrest.core.StringContains.containsString")
                    replace("hamcrest: CoreMatchers", "import org.hamcrest.CoreMatchers;", "import static org.hamcrest.CoreMatchers.anything;")
                    replace("hamcrest: emptyArray", "org.hamcrest.Matchers.emptyArray", "org.hamcrest.collection.IsArrayWithSize.emptyArray")
                    replace("hamcrest: endsWidth", "org.hamcrest.CoreMatchers.endsWith", "org.hamcrest.core.StringEndsWith.endsWith")
                    replace("hamcrest: equalTo", "org.hamcrest.CoreMatchers.equalTo", "org.hamcrest.core.IsEqual.equalTo")
                    replace("hamcrest: greaterThanOrEqualTo", "org.hamcrest.Matchers.greaterThanOrEqualTo", "org.hamcrest.number.OrderingComparison.greaterThanOrEqualTo")
                    replace("hamcrest: greaterThan", "org.hamcrest.Matchers.greaterThan", "org.hamcrest.number.OrderingComparison.greaterThan")
                    replace("hamcrest: hasItem", "org.hamcrest.CoreMatchers.hasItem", "org.hamcrest.core.IsIterableContaining.hasItem")
                    replace("hamcrest: hasItems", "org.hamcrest.CoreMatchers.hasItems", "org.hamcrest.core.IsIterableContaining.hasItems")
                    replace("hamcrest: hasSize", "org.hamcrest.Matchers.hasSize", "org.hamcrest.collection.IsCollectionWithSize.hasSize")
                    replace("hamcrest: hasToString", "org.hamcrest.Matchers.hasToString", "org.hamcrest.object.HasToString.hasToString")
                    replace("hamcrest: instanceOf", "org.hamcrest.CoreMatchers.instanceOf", "org.hamcrest.core.IsInstanceOf.instanceOf")
                    replace("hamcrest: instanceOf", "org.hamcrest.Matchers.instanceOf", "org.hamcrest.core.IsInstanceOf.instanceOf")
                    replace("hamcrest: is", "org.hamcrest.CoreMatchers.is", "org.hamcrest.core.Is.is")
                    replace("hamcrest: is", "org.hamcrest.Matchers.is", "org.hamcrest.core.Is.is")
                    replace("hamcrest: isA", "org.hamcrest.CoreMatchers.isA", "org.hamcrest.core.Is.isA")
                    replace("hamcrest: lessThanOrEqualTo", "org.hamcrest.Matchers.lessThanOrEqualTo", "org.hamcrest.number.OrderingComparison.lessThanOrEqualTo")
                    replace("hamcrest: lessThan", "org.hamcrest.Matchers.lessThan", "org.hamcrest.number.OrderingComparison.lessThan")
                    replace("hamcrest: Matchers", "import org.hamcrest.Matchers;", "import static org.hamcrest.Matchers.allOf;")
                    replace("hamcrest: notNullValue", "org.hamcrest.CoreMatchers.notNullValue", "org.hamcrest.core.IsNull.notNullValue")
                    replace("hamcrest: notNullValue", "org.hamcrest.Matchers.notNullValue", "org.hamcrest.core.IsNull.notNullValue")
                    replace("hamcrest: not", "org.hamcrest.CoreMatchers.not", "org.hamcrest.core.IsNot.not")
                    replace("hamcrest: not", "org.hamcrest.Matchers.not", "org.hamcrest.core.IsNot.not")
                    replace("hamcrest: nullValue", "org.hamcrest.CoreMatchers.nullValue", "org.hamcrest.core.IsNull.nullValue")
                    replace("hamcrest: nullValue", "org.hamcrest.Matchers.nullValue", "org.hamcrest.core.IsNull.nullValue")
                    replace("hamcrest: sameInstance", "org.hamcrest.CoreMatchers.sameInstance", "org.hamcrest.core.IsSame.sameInstance")
                    replace("hamcrest: startsWith", "org.hamcrest.CoreMatchers.startsWith", "org.hamcrest.core.StringStartsWith.startsWith")
