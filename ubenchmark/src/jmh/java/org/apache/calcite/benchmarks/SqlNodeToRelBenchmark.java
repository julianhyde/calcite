...
@Threads(1)
public class SqlNodeToRelBenchmark {

  /**
   * A state holding information needed to convertToRel.
   */
  @State(Scope.Thread)
  ...
  @Benchmark
  public RelNode convertToRel(BenchmarkState state) throws Exception {
    return state.convertToRel();
  }

  public static void main(String[] args) throws RunnerException {
    Options opt = new OptionsBuilder()
        .include(SqlNodeToRelBenchmark.class.getSimpleName())
