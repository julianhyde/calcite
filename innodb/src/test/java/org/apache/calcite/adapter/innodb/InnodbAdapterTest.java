...
public class InnodbAdapterTest {
  ...
  static final PairList<Integer, String> ROWS =
      PairList.<Integer, String>builder()
          .add(7369, "EMPNO=7369; ENAME=SMITH; JOB=CLERK; AGE=30; MGR=7902; "
              ...
              + expectedLocalTime("2020-01-01 18:35:40"))
          .add(7499, "EMPNO=7499; ENAME=ALLEN; JOB=SALESMAN; AGE=24; MGR=7698; "
              ...
              + expectedLocalTime("2018-04-09 09:00:00"))
          .add(7521, "EMPNO=7521; ENAME=WARD; JOB=SALESMAN; AGE=41; MGR=7698; "
              ...
              + expectedLocalTime("2019-11-16 10:26:40"))
          .add(7566, "EMPNO=7566; ENAME=JONES; JOB=MANAGER; AGE=28; MGR=7839; "
              ...
              + expectedLocalTime("2015-03-09 22:16:30"))
          .add(7654, "EMPNO=7654; ENAME=MARTIN; JOB=SALESMAN; AGE=27; MGR=7698; "
              ...
              + expectedLocalTime("2018-09-02 12:12:56"))
          .add(7698, "EMPNO=7698; ENAME=BLAKE; JOB=MANAGER; AGE=38; MGR=7839; "
              ...
              + expectedLocalTime("2018-06-01 14:45:00"))
          .add(7782, "EMPNO=7782; ENAME=CLARK; JOB=MANAGER; AGE=32; MGR=7839; "
              ...
              + expectedLocalTime("2019-09-30 02:14:56"))
          .add(7788, "EMPNO=7788; ENAME=SCOTT; JOB=ANALYST; AGE=45; MGR=7566; "
              ...
              + expectedLocalTime("2019-07-28 12:12:12"))
          .add(7839, "EMPNO=7839; ENAME=KING; JOB=PRESIDENT; AGE=22; MGR=null; "
              ...
              + expectedLocalTime("2019-06-08 15:15:15"))
          .add(7844, "EMPNO=7844; ENAME=TURNER; JOB=SALESMAN; AGE=54; MGR=7698; "
              ...
              + expectedLocalTime("2017-08-17 22:01:37"))
          .add(7876, "EMPNO=7876; ENAME=ADAMS; JOB=CLERK; AGE=35; MGR=7788; "
              ...
              + expectedLocalTime("2017-08-18 23:11:06"))
          .add(7900, "EMPNO=7900; ENAME=JAMES; JOB=CLERK; AGE=40; MGR=7698; "
              ...
              + expectedLocalTime("2020-01-02 12:19:00"))
          .add(7902, "EMPNO=7902; ENAME=FORD; JOB=ANALYST; AGE=28; MGR=7566; "
              ...
              + expectedLocalTime("2019-05-29 00:00:00"))
          .add(7934, "EMPNO=7934; ENAME=MILLER; JOB=CLERK; AGE=32; MGR=7782; "
  ...
  static List<Pair<Integer, String>> rows() {
    return ROWS.transform(Pair::of);
  }

  static final List<Map.Entry<Integer, String>> REVERSED_ROWS =
      rows().stream().sorted(Comparator.reverseOrder()).collect(toList());

  static final Map<Integer, String> EMPNO_MAP =
      rows().stream().collect(Collectors.toMap(Pair::getKey, Pair::getValue));
  ...
  private static String someEmpnoGt(int empno) {
    return some(ROWS.leftList().stream().filter(i -> i > empno).collect(toList()));
  }
  ...
  private static String some(List<Integer> empnos) {
    List<String> result = empnos.stream()
        .map(EMPNO_MAP::get).collect(toList());
    return join(result);
  }
