...
class TraitPropagationTest {
  ...
  /** Rule for PhysAgg. */
  public static class PhysAggRule extends RelOptNewRule<PhysAggRule.Config> {
  ...
  /** Rule for PhysProj. */
  public static class PhysProjRule extends RelOptNewRule<PhysProjRule.Config> {
  ...
  public static class PhysTableRule
      extends RelOptNewRule<PhysTableRule.Config> {
