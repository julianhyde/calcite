...
public class SqlToRelConverter {
  ...
  protected void convertSelectImpl(
    ...
    if (RelOptUtil.isPureOrder(bb.root())
  ...
  private @Nullable RelNode convertQueryOrInList(
    ...
    if (seek instanceof SqlNodeList) {
      ...
      bb.setRoot(null); // TODO remove; temp to sync local and global roots
  ...
  private void convertUnnest(Blackboard bb, SqlCall call, @Nullable List<String> fieldNames) {
    ...
    RelNode child =
        bb.rootIsNull() ? LogicalValues.createOneRow(cluster)
            : bb.root();
    RelNode uncollect;
  ...
  private Pair<RexNode, RelNode> convertOnCondition(
    ...
    final RelNode newRightRel =
        bb.rootIsNull() || bb.registered.size() == 0
            ? rightRel
  ...
  private void convertQualify(Blackboard bb, @Nullable SqlNode qualify) {
    ...
    final RelNode originalRoot = bb.root();
...
//        throw new AssertionError();
    ...
    void setRoot(@Nullable RelNode root) {
