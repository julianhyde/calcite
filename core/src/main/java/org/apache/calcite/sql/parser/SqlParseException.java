...
public class SqlParseException extends Exception
  ...
  private final int @Nullable[][] expectedTokenSequences;
  private final String @Nullable[] tokenImages;

  /**
   * The original exception thrown by the generated parser. Unfortunately,
   * each generated parser throws exceptions that have a different class. So,
   * we keep the exception for forensic purposes, but don't print it publicly.
   *
  ...
  public SqlParseException(
      String message,
      @Nullable SqlParserPos pos,
      int @Nullable [][] expectedTokenSequences,
      String @Nullable [] tokenImages,
    ...
    super(message, null);
    this.pos = first(pos, SqlParserPos.ZERO);
  ...
  public Collection<String> getExpectedTokenNames() {
    ...
    requireNonNull(tokenImages, "tokenImages");
    for (int[] expectedTokenSequence : expectedTokenSequences) {
   ...
   * @return token images
   */
  public String @Nullable [] getTokenImages() {
    return tokenImages;
  }
   ...
   */
  public int @Nullable [][] getExpectedTokenSequences() {
