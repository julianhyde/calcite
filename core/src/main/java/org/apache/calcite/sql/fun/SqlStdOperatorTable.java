...
public class SqlStdOperatorTable extends ReflectiveSqlOperatorTable {
  ...
  public static final SqlPrefixOperator NOT =
      new SqlPrefixOperator(
          ...
          SqlKind.NOT,
          26,
          ReturnTypes.ARG0.nullDefault(SqlTypeName.BOOLEAN),
          InferTypes.BOOLEAN,
          OperandTypes.BOOLEAN);
  ...
  public static final SqlPrefixOperator UNARY_MINUS =
      new SqlPrefixOperator(
          ...
          80,
          ReturnTypes.ARG0.nullDefault(SqlTypeName.DECIMAL),
          InferTypes.RETURN_TYPE,
  ...
  public static final SqlFunction UPPER =
      new SqlFunction(
          "UPPER",
          SqlKind.OTHER_FUNCTION,
          ReturnTypes.ARG0_NULLABLE.nullDefault(SqlTypeName.VARCHAR),
          null,
          OperandTypes.CHARACTER,
  ...
  public static final SqlFunction MOD =
      ...
      new SqlFunction(
          "MOD",
          SqlKind.MOD,
          ReturnTypes.ARG1_NULLABLE.nullDefault(SqlTypeName.DECIMAL),
          null,
          OperandTypes.EXACT_NUMERIC_EXACT_NUMERIC,
          SqlFunctionCategory.NUMERIC);
  ...
  public static final SqlFunction ROUND =
      new SqlFunction(
          "ROUND",
          SqlKind.OTHER_FUNCTION,
          ReturnTypes.ARG0_NULLABLE.nullDefault(SqlTypeName.DECIMAL),
          null,
  ...
  public static final SqlAggFunction FUSION =
      new SqlAggFunction("FUSION", null,
          SqlKind.FUSION,
          ReturnTypes.ARG0.nullDefault(SqlTypeName.MULTISET),
          null,
          OperandTypes.MULTISET,
          SqlFunctionCategory.SYSTEM, false, false,
